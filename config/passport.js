...
const convertPhoneNumber = require('./utility.js').convertPhoneNumber;

// expose this function to our app using module.exports
module.exports = (passport, textingClient) => {
    ...
    function(req, email, password, done) { // callback with email and password from our form
        ...
        User.findOne({ $or: [{ 'local.email' :  email }, {'username': email }, {'phoneNumber': email}]}, function(err, user) {
            ...
            if (!user)
                return done(null, false, req.flash('loginMessage', 'No user with that username or password has been found.')); // req.flash is the way to set flashdata using connect-flash
